...
window.onload = function main() {
  ...
  (function setupColors() {
    colorBlue.style.backgroundColor = window.getComputedStyle(colorBlue).backgroundColor;
    colorRed.style.backgroundColor = window.getComputedStyle(colorRed).backgroundColor;
